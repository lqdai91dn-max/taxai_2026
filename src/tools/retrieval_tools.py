"""
Retrieval tools — wrap HybridSearch.
...
# Lazy-load để không block import khi chưa cần ChromaDB
_hybrid_search = None
...
# ═══════════════════════════════════════════════════════════════════════════════
# TOOL 4 — get_article (REMOVED: Neo4j dependency removed)
# ═══════════════════════════════════════════════════════════════════════════════

def get_article(article_id: str) -> dict:
    """Stub — Neo4j removed. Use search_legal_docs instead."""
    return {"article_id": article_id, "found": False,
            "error": "get_article disabled — use search_legal_docs"}
    return "\n".join(lines)
